...
export default function UsersAdminPage() {
  ...
  const handleTokenUpdate = async () => {
    ...
    const amount = Number.parseInt(newTokenAmount, 10);
  ...
  return (
    <>
          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-muted/50 text-muted-foreground text-[10px] uppercase font-bold tracking-widest">
              <tr>
                ...
                <th className="px-5 py-4 font-mono text-primary/70">
                  Usage_HEX
                </th>
              ...
              {filteredUsers?.map((u: any) => (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-[11px] font-bold text-muted-foreground tracking-tight">
                    {u.full_name || (
                      <span className="opacity-20">NOT_DISCLOSED</span>
                    )}
                  </td>
                  <td className="px-5 py-4">
                    <span
                  ...
                  <td className="px-5 py-4">
                    ...
                    >
                      <div
                        className={`size-1 rounded-full ${u.is_active ? "bg-emerald-500" : "bg-red-500"}`}
                      />
                  ...
                  <td className="px-5 py-4 font-mono text-muted-foreground/80 text-xs">
                    <button
                      ...
                      onClick={() => openTokenDialog(u.id, u.total_usage)}
                    >
                  ...
                  <td className="px-5 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        onClick={() => initiateRoleUpdate(u.id, u.role)}
                      >
      ...
      <Dialog onOpenChange={setTokenDialogOpen} open={tokenDialogOpen}>
        <DialogContent className="sm:max-w-[425px] bg-card border-border/40">
          ...
          <DialogFooter>
            <Button onClick={() => setTokenDialogOpen(false)} variant="outline">
              CANCEL
            </Button>
      ...
      <AlertDialog onOpenChange={setConfirmRoleOpen} open={confirmRoleOpen}>
